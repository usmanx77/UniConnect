...
export function PostCard({ post }: { 
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              {post.department} • {post.batch} • {post.timeAgo}
            </p>
          </div>
        </div>
        <div className="flex gap-1">
          <Button
            ...
            className={`rounded-xl h-8 w-8 ${isBookmarked ? "text-primary" : ""}`}
          >
      ...
      {/* Images */}
      {images.length > 0 && (
        <div className={`mb-3 rounded-xl overflow-hidden grid gap-1 ${
      ...
      <div className="flex items-center gap-2">
        ...
        <Button variant="ghost" size="sm" className="rounded-xl gap-1 flex-1">
